...
public class FetchAddressIntentService extends IntentService {
    ...
    @SuppressLint("RestrictedApi")
    private void deliverResultToReceiver(int resultCode, List<Address> message) {
        Bundle bundle = new Bundle();
        bundle.putParcelableArrayList(Constants.RESULT_DATA_KEY, (ArrayList<? extends Parcelable>) message);
        mReceiver.send(resultCode, bundle);
    }
}